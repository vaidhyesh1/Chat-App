...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    require_once("function.php");
      ...
      $stmt = $mysqli1->prepare("Select groups from logincred  WHERE username = '".$_SESSION['user']."'") ; 
      $stmt->execute();	
      ...
      foreach($groupnames as $value){
          echo '<tr>';
        $stmt1 = $mysqli1->prepare("Select members from groupname  WHERE name = '".$value."'"); 
        $stmt1->execute();	
        $stmt1->bind_result($members); 
        $stmt1->fetch(); 
        $stmt1->close();
        echo '<td>'.$value.'</td>';
        echo '<td>'.$members.'</td>';        
